...
export default function (Vue, {router, head, isClient}) {
  ...
  head.meta.push({ hid: 'og:image', name: 'og:image', content: 'https://zack-cuddy.com/images/Me.png' })
  ...
  head.meta.push({ hid: 'twitter:image', name: 'twitter:image', content: 'https://zack-cuddy.com/images/Me.png'} )
